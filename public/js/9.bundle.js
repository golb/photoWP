...
/***/ function(module, exports, __webpack_require__) {
	...
	var _exifyIt = __webpack_require__(7);

	var _exifyIt2 = _interopRequireDefault(_exifyIt);
	...
	var slides = {
	    ...
	    slider: function slider(target) {
	        ...
	        if (!this.clickedCurrentSlide(target)) {
	            (function () {
	                var currentSlide = _this.getIndexSlide(linearSliderController.querySelector('.current')),
	                    futureSlide = _this.getIndexSlide(target);
	                if (futureSlide > currentSlide) {
	                    _this.moveSlidesToLeft(currentSlide, futureSlide);
	                } else {
	                    _this.moveSlidesToRight(currentSlide, futureSlide);
	                }
	                ...
	                var img = new Image();
	                img.src = getComputedStyle(fullScreenSlider.children[futureSlide]).backgroundImage.slice(4, -1);
	                img.onload = function () {
	                    _exifyIt2['default'].getData(img, function () {
	                        if (!isEmptyObject(_exifyIt2['default'].getAllTags(this))) {
	                            var make = _exifyIt2['default'].getTag(this, "Make");
	                            var model = _exifyIt2['default'].getTag(this, "Model");
	                            var iso = _exifyIt2['default'].getTag(this, "ISOSpeedRatings");
	                            var focal = _exifyIt2['default'].getTag(this, "FocalLength");
	                            var aperture = _exifyIt2['default'].getTag(this, "ApertureValue");
	                            var artist = _exifyIt2['default'].getTag(this, "Artist");
	                            var exposure = _exifyIt2['default'].getTag(this, "ExposureTime");
	                            var allMetaData = _exifyIt2['default'].getAllTags(this);
